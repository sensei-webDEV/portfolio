...
const Card = ({ title = '', content, icons = [], stripeText, right = null, left = null, condensed = false }) => {
  return (
    <div className='relative h-[450px] lg:w-[410px] card-container flex flex-col items-center justify-between px-8 py-8 m-5 rounded-md bg-white-100 drop-shadow-md'>
      {/* Stripe */}
      ...
      {/* Description */}
      <div
        className='content mt-4 max-w-[30ch] font-poppins font-normal text-base leading-snug tracking-wide text-justify hyphens-auto pt-2 px-1 lg:text-xs 3.5xl:text-sm 4xl:text-tiny'
